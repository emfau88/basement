...
export const projects: Record<ProjectKey, Project> = {
  territory_tide: {
    ...
    type: 'game',
    image: 'https://raw.githubusercontent.com/emfau88/hexwars/main/docs/readme/gameplay-desktop.png',
  ...
  core_arena: {
    ...
    category: 'Featured Game',
    type: 'game',
    image: 'https://raw.githubusercontent.com/emfau88/CTF-3.0/main/docs/screenshots/menu-refresh-2026-08-24-v2/custom-match-arena-desktop-de.png',
  ...
  pocket_pier: {
    ...
    image: 'https://raw.githubusercontent.com/emfau88/PocketPier/master/docs/screenshots/sunny-pier.png',
  ...
  kessel_krawall: {
    ...
    image: 'https://raw.githubusercontent.com/emfau88/KesselKrawall/main/public/og.png',
  ...
  mirror: {
    id: 'mirror', title: 'Mirror', category: 'Featured App', type: 'app', image: 'https://emfau88.github.io/portfolio2/assets/mirror.png',
  ...
  zerohero: {
    id: 'zerohero', title: 'ZeroHero', category: 'Featured App', type: 'app', image: 'https://emfau88.github.io/portfolio2/assets/zero2.png',
  ...
  between: {
    id: 'between', title: 'between', category: 'Featured App', type: 'app', image: 'https://emfau88.github.io/portfolio2/assets/between.png',
  ...
  chargegeist: {
    id: 'chargegeist', title: 'ChargeGeist', category: 'Featured App', type: 'app', image: 'https://emfau88.github.io/portfolio2/assets/Chargegeist2.jpeg',
  ...
  cozy_bunker: {
    id: 'cozy_bunker', title: 'Cozy Bunker', category: 'Archive', type: 'archive', image: 'https://raw.githubusercontent.com/emfau88/Bunker/main/docs/screenshots/surface.png',
  ...
  cloudtop_run: {
    id: 'cloudtop_run', title: 'Cloudtop Run', category: 'Archive', type: 'archive', image: 'https://emfau88.github.io/portfolio2/assets/cloudtop-run.jpg',
  ...
  tinywar2: {
    id: 'tinywar2', title: 'TinyWar 2.0', category: 'Archive', type: 'archive', image: 'https://emfau88.github.io/portfolio2/assets/tinywar-2.jpg',
  ...
  more_than_wombat: {
    id: 'more_than_wombat', title: 'More Than Wombat', category: 'Archive', type: 'archive', image: 'https://emfau88.github.io/portfolio2/assets/wombat.jpg',
